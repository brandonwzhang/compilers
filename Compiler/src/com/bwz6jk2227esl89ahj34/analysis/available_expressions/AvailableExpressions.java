...
public class AvailableExpressions extends DataflowAnalysis{
    ...
    /**
     * Returns the LatticeElement of eval[node]. The element is a set of all
     * subexpressions generated by the node
     */
    ...
    /**
     * Removes kill[node] from the set out. Used because it is hard to do a
     * set difference (see Transfer)
     */
    ...
    /**
     * Return a set of expressions that are subexpression of expr
     * (including expr itself). Analogous to powerset
     * @param expr
     * @return
     */
     ...
     * Excludes Temps, Consts, Names, etc.
     */
    ...
    /**
     * Returns the size (number of terms) in a given expression
     * @param expr
     * @return
     */
     ...
     * Many hours of pain were spent debugging the line
